...
public class Solution {
    ...
    public static class Countdown implements Runnable {
        ...
        public void printCountdown() throws InterruptedException {
            System.out.println(list.get(countFrom-- - 1));// почему то передается не индекс а колличественный параметр
            // хотя в условии говориться что индекс, по этому чтобы сделат индекс уменьшаем на 1
