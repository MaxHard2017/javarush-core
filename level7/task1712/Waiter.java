...
public class Waiter implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Weiter stopping - Dishes queue: " + Manager.getInstance().getDishesQueue().isEmpty());
        System.out.println("Weiter stopping - Order queue: " + Manager.getInstance().getOrderQueue().isEmpty());
